...
export class AevaBarChart extends LitElement {
    ...
    render() {
        ...
        if (numDataPoints === 0) {
            return html`<div class="chart-container" style="display:flex;align-items:center;justify-content:center;color:var(--text-color)">No data available</div>`;
        }
        ...
        return html`
            ...
            if (this.stacked) {
                ...
                const numSeriesInThisGroup = item.values.length;
