...
export class AevaToast extends WithCloseAnimation(LitElement) {
  static styles = [
    accessibilityStyles,
    css`
      :host {
      ...
      .toast {
        position: relative;
        background: var(--aeva-toast-bg, var(--aeva-surface-glass, #ffffff));
      ...
      .content {
        flex: 1;
        color: var(--aeva-toast-text-color, var(--aeva-text-color, #1f2937));
        font-size: 0.95rem;
        line-height: 1.5;
      }
      ...
      .close-button {
        ...
        align-items: center;
        justify-content: center;
        color: var(--aeva-toast-close-color, var(--aeva-text-muted, #6b7280));
        transition: all 0.2s;
        width: 24px;
        height: 24px;
      }
      ...
      .close-button:hover {
        background: var(--aeva-toast-close-hover-bg, rgba(0, 0, 0, 0.1));
        color: var(--aeva-toast-close-hover-color, var(--aeva-text-color, #333));
      }
      ...
      :host([variant='success']) .toast {
        --aeva-toast-bg: var(--aeva-toast-success-bg, rgba(220, 252, 231, 0.95));
        --aeva-toast-border-color: var(--aeva-toast-success-border, rgba(34, 197, 94, 0.3));
      }

      :host([variant='success']) .icon {
        color: var(--aeva-toast-success-icon, #16a34a);
      }

      :host([variant='error']) .toast {
        --aeva-toast-bg: var(--aeva-toast-error-bg, rgba(254, 226, 226, 0.95));
        --aeva-toast-border-color: var(--aeva-toast-error-border, rgba(239, 68, 68, 0.3));
      }

      :host([variant='error']) .icon {
        color: var(--aeva-toast-error-icon, #dc2626);
      }

      :host([variant='warning']) .toast {
        --aeva-toast-bg: var(--aeva-toast-warning-bg, rgba(254, 243, 199, 0.95));
        --aeva-toast-border-color: var(--aeva-toast-warning-border, rgba(245, 158, 11, 0.3));
      }

      :host([variant='warning']) .icon {
        color: var(--aeva-toast-warning-icon, #d97706);
      }

      :host([variant='info']) .toast {
        --aeva-toast-bg: var(--aeva-toast-info-bg, rgba(219, 234, 254, 0.95));
        --aeva-toast-border-color: var(--aeva-toast-info-border, rgba(59, 130, 246, 0.3));
      }

      :host([variant='info']) .icon {
        color: var(--aeva-toast-info-icon, #2563eb);
      }
  ...
  private handleOpen() {
    this.closing = false; // Ensure closing state is reset when opening
