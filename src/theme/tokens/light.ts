...
export const lightTheme: ThemeVariables = {
  ...
  '--aeva-page-gradient':
    'linear-gradient(135deg, var(--aeva-color-gray-50) 0%, var(--aeva-color-gray-200) 100%)',
  ...
  '--aeva-surface-tertiary': 'var(--aeva-color-gray-100)',
  '--aeva-surface-glass': 'rgba(255, 255, 255, 0.9)',
  ...
  '--aeva-modal-shimmer-gradient':
    'linear-gradient(90deg, rgba(255, 255, 255, 0.6) 0%, rgba(255, 255, 255, 0.1) 50%, rgba(255, 255, 255, 0.6) 100%)',
  ...
  '--aeva-rating-label-color': 'var(--aeva-color-gray-500)',
  ...
  '--aeva-list-item-color': 'var(--aeva-color-gray-900)',
  '--aeva-list-item-hover-bg': 'rgba(0, 0, 0, 0.04)',
  '--aeva-list-item-active-bg': 'rgba(102, 126, 234, 0.08)',
  '--aeva-list-item-active-color': 'var(--aeva-color-indigo-500)',
  ...
  // Code
  '--aeva-code-bg': '#1e1e1e',
  '--aeva-code-header-bg': '#323232',
  '--aeva-code-footer-bg': '#1e1e1e',
  '--aeva-code-text-color': '#d4d4d4',
  '--aeva-code-title-color': 'rgba(255, 255, 255, 0.4)',
  '--aeva-code-dot-red': '#ff5f56',
  '--aeva-code-dot-yellow': '#ffbd2e',
  '--aeva-code-dot-green': '#27c93f',
  '--aeva-code-copy-btn-bg': 'rgba(255, 255, 255, 0.05)',
  '--aeva-code-copy-btn-color': 'rgba(255, 255, 255, 0.6)',
  ...
  '--aeva-code-copy-btn-active-bg': 'rgba(39, 201, 63, 0.2)',
  '--aeva-code-copy-btn-active-color': '#27c93f',
  '--aeva-code-copy-btn-active-border': 'rgba(39, 201, 63, 0.3)',
  ...
  '--aeva-tab-item-focus-ring': '2px solid rgba(102, 126, 234, 0.5)',

  // Toast
  '--aeva-toast-bg': 'rgba(255, 255, 255, 0.9)',
  '--aeva-toast-text-color': 'var(--aeva-color-gray-800)',
  '--aeva-toast-close-color': 'var(--aeva-color-gray-600)',
  '--aeva-toast-close-hover-color': 'var(--aeva-color-gray-900)',
  ...
  '--aeva-toast-success-bg': 'rgba(220, 252, 231, 0.95)',
  '--aeva-toast-success-border': 'rgba(34, 197, 94, 0.3)',
  '--aeva-toast-success-icon': '#16a34a',
  '--aeva-toast-error-bg': 'rgba(254, 226, 226, 0.95)',
  '--aeva-toast-error-border': 'rgba(239, 68, 68, 0.3)',
  '--aeva-toast-error-icon': '#dc2626',
  '--aeva-toast-warning-bg': 'rgba(254, 243, 199, 0.95)',
  '--aeva-toast-warning-border': 'rgba(245, 158, 11, 0.3)',
  '--aeva-toast-warning-icon': '#d97706',
  '--aeva-toast-info-bg': 'rgba(219, 234, 254, 0.95)',
  '--aeva-toast-info-border': 'rgba(59, 130, 246, 0.3)',
  '--aeva-toast-info-icon': '#2563eb',
  ...
  '--aeva-accordion-item-border-color': 'var(--aeva-color-gray-200)',
  '--aeva-accordion-header-padding': 'var(--aeva-space-md)',
  '--aeva-accordion-content-padding': 'var(--aeva-space-md)',
  '--aeva-accordion-header-hover-bg': 'rgba(0, 0, 0, 0.04)',
  '--aeva-accordion-transition': 'var(--aeva-transition-normal)',

  // Pagination
  '--aeva-pagination-gap': 'var(--aeva-space-xs)',
  '--aeva-pagination-btn-size': '40px',
  '--aeva-pagination-btn-bg': 'var(--aeva-color-white)',
  '--aeva-pagination-btn-color': 'var(--aeva-color-gray-700)',
  '--aeva-pagination-btn-hover-bg': 'var(--aeva-color-gray-100)',
  '--aeva-pagination-btn-active-bg': 'var(--aeva-primary-color)',
  '--aeva-pagination-btn-active-color': 'var(--aeva-color-white)',
